...
** lsp-mode
#+begin_src emacs-lisp
     ;(eval-after-load "~/Brain-dump/opx-db-conns.el.gpg"
    ;   '(require opx-creds "~/Brain-dump/opx-db-conns.el.gpg"))
  (use-package lsp-mode
       ...
       (setq lsp-sqls-connections
	     '(((driver . "oracle") (dataSourceName . "OPX_DEV_BEG/Welcome$123@rb0orarac28.de.bosch.com:38000/OPXDEV_rb0orarac28.de.bosch.com"))))
