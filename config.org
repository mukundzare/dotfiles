...
#+end_src
** Planisware script font locking
This code exists in the common-plw.el file which has been ported here to prevent overwriting in case the git repo changes
#+begin_src emacs-lisp
  ;(custom-set-faces
  ...
  ; '(font-lock-variable-name-face ((((class color) (background light)) (:foreground "magenta2")))))
#+end_src
** REPL customizations
