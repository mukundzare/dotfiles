...
#+end_src
** Auto text resize depending on monitor
#+begin_src emacs-lisp
  (use-package textsize
    ...
    :config
    (setq textsize-monitor-size-thresholds '((0 . 3)
                                             (350 . 0)
                                             (500 . 3)))
    (setq textsize-pixel-pitch-thresholds '((0 . 2)
                                            (0.12 . 0)
                                            (0.18 . -3))))
#+end_src
* Language specific
...
#+begin_src emacs-lisp
  ...
  ;;Settings for database connections for lsp-mode
  ...
  (use-package org
    ...
    (setq org-capture-templates
          `(("t" "Tasks / Projects")
            ...
            ("j" "Journal Entries")
            ("jj" "Journal" entry
             (file+olp+datetree "~/orgfiles/Journal.org.gpg")
            ...
            ("jm" "Meeting" entry
             ...
             :empty-lines 1)
            ("w" "Workflows")
            ("we" "Checking Email" entry (file+olp+datetree "~/orgfiles/Journal.org.gpg")
            ...
            ("oo" "Task" entry (file+olp "~/orgfiles/work_diary.org" "Inbox")
             "* TODO %?\n  %U\n  %a\n  %i" :empty-lines 1)
            ("oj" "Journal" entry
             (file+olp+datetree "~/orgfiles/Work-Journal.org.gpg")
             "\n* %<%I:%M %p> - Journal :journal:\n\n%?\n\n"
             :clock-in :clock-resume
             :empty-lines 1)))
    (require 'org-tempo)
...
** Keybindings
#+begin_src emacs-lisp
  (define-key *ojs-mode-map* (kbd "C-c m e") 'opx2-exec-region-in-repl)
  (define-key *ojs-mode-map* (kbd "C-c m c") 'opx2-clear-repl-buffer)
  (define-key *pjs-mode-map* (kbd "C-c m e") 'opx2-exec-region-in-repl)
  (define-key *pjs-mode-map* (kbd "C-c m c") 'opx2-clear-repl-buffer)
#+end_src
